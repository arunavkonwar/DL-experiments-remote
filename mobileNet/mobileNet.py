...
if __name__ == "__main__":
	...
	y_filename ='/udd/akonwar/code/deep-learning-for-visual-servoing/data/data.txt'
	...
	h5f = h5py.File('/udd/akonwar/code/deep-learning-for-visual-servoing/images_in_h5_format.h5','r')
